        ...
        <div class="span10">
            ...
            <div class="widget green">
                ...
                <div class="widget-body">
                    ...
                    @endif
                    <form action="{{route('update_question')}}" method="post" class="form-horizontal">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select id="class_id" data-placeholder="Your Favorite Type of Bear" name="exam_id"
                                    ...
                                    <option value="{{$exam->id}}" {{ $exam->id == $question->exam_id ? 'selected' : '' }}  >{{$exam->exam_name}}</option>
                                    @endforeach
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="number" name="question_number" value="{{$question->question_number}}" class="span6 " />
                                <input type="hidden" name="question_id" value="{{$question->id}}" class="span6 " />
                        ...
                        <div class="control-group">
                            <label class="control-label">Question Name</label>
                            <div class="controls">
                                <textarea class="span12 ckeditor" name="question_name" rows="4">{{$question->question_name}}</textarea>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Question A</label>
                            <div class="controls">
                                <textarea class="span12 ckeditor" name="A" rows="4">{{$question->A}}</textarea>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Question B</label>
                            <div class="controls">
                                <textarea class="span12 ckeditor" name="B" rows="4">{{$question->B}}</textarea>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Question C</label>
                            <div class="controls">
                                <textarea class="span12 ckeditor" name="C" rows="4">{{$question->C}}</textarea>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Question D</label>
                            <div class="controls">
                                <textarea class="span12 ckeditor" name="D" rows="4">{{$question->D}}</textarea>
                            </div>
                        </div>
