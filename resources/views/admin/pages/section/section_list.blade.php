                ...
                <div class="widget-body">
                    <table class="table table-striped table-bordered table-advance table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><a href="#">{{$section->id}}</a></td>
                                <td>Class {{$section->class_info->class_number}} </td>
                                <td><span class="label label-important label-mini">{{$section->teacher_info->name}} </span></td>
                                <td><span class="label label-important label-mini">{{$section->section_name}}  </span></td>
                                <td>
