        ...
        <div class="span10">
            ...
            <div class="widget green">
                ...
                <div class="widget-body">
                    ...
                    @endif
                    <form action="{{route('post_notice')}}" method="post" class="form-horizontal"
                        enctype="multipart/form-data">

                        @csrf
                    <div class="control-group">
                            <label class="control-label"> Class Name (optional)</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" required name="title" class="span6 " />
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea class="span6 " required name="description" rows="3"></textarea>
                            </div>
                        </div>
                        <div class="control-group">
