                    ...
                    <table class="table table-striped table-bordered table-advance table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="hidden-phosne"><i class="icon-class"></i>Title</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><a href="#">{{$notice->id}}</a></td>
                                <td>{{$notice->title}} </td>
                                <td><span class="label label-important label-mini">{{$notice->description}} </span></td>
                                <td><span class="label label-important label-mini">{{$notice->date}}</span></td>
                                <td>
