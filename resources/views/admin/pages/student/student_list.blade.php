                    ...
                    <table class="table table-striped table-bordered table-advance table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="label label-important label-mini">{{$student->name}}</span></td>
                                <td>{{$student->gender}} </td>
                                <td><span class="label label-important label-mini">Class {{$student->class}}</span></td>
