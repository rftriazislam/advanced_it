                    ...
                    <div class="widget-body">
                        <div class="timeline-messages">
                            ...
                            <div class="msg-time-chat">
                                <a class="message-img" href="#"><img alt="" src="public/img/avatar1.jpg"
                                        class="avatar"></a>
                            ...
                            <!-- Comment -->
                            <div class="msg-time-chat">
                                <a class="message-img" href="#"><img alt="" src="public/img/avatar2.jpg"
                                        class="avatar"></a>
                            ...
                            <div class="msg-time-chat">
                                ...
                                <div class="message-body msg-out">
                                    <span class="arrow"></span>
                                    <div class="text">
                                        <p class="attribution"><a href="#">Jonathan Smith</a> at 2:05pm, 13th April 2013
                                        </p>
            ...
            <div class="span5">
                ...
                <div class="widget purple">
                    ...
                    <div class="widget-body">
                        <ul class="unstyled">
                            <li>
                                <span class="btn btn-inverse"> <i class="icon-refresh"></i></span> Update Jquery <strong
                                    class="label"> 48%</strong>
                                <div class="space10"></div>
                                <div class="progress">
