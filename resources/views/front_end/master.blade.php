...
<head>
    ...
    <!--====== Nice Number css ======-->
    <link rel="stylesheet" href="{{asset('front_end/css/jquery.nice-number.min.css')}}">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-8">
                        <div class="header-contact text-lg-left text-center">
                            <ul>
                                <li><img src="{{ asset('front_end/images/all-icon/call.png') }}" alt="icon"><span>(124)
                                        123 675 598</span></li>
                                <li><img src="{{ asset('front_end/images/all-icon/email.png') }}"
                                        alt="icon"><span>info@yourmail.com</span></li>
                                <li><img src="{{ asset('front_end/images/all-icon/map.png') }}" alt="icon"><span>127/5
                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul class="navbar-nav ml-auto">
                                    ...
                                    @if(Auth::user()=='')
                          <a href="{{route('login')}}" style=" color:#006b30">Login</a>

                          @elseif(Auth::user()->role=='admin')
                          <a href="{{route('admin')}}" style=" color:#5ef22e">Admin</a>
                          @elseif(Auth::user()->role=='blogger')
                          <a href="{{route('teacher')}}" style=" color:#40adec">Teacher</a>
                          @elseif(Auth::user()->role=='blogger')
                          <a href="{{route('librarian')}}" style=" color:#40adec">Librarian</a>
                          @elseif(Auth::user()->role=='blogger')
                          <a href="{{route('accountant')}}" style=" color:#40adec">Accountant</a>
                          @else
                          <a href="{{route('logout')}}" style=" color:#f74e4e">logout</a>
                          @endif
...
@yield('content')
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-about mt-40">
                            <div class="logo">
                                <a href="#"><img src="{{ asset('front_end/images/logo3.png') }}" alt="Logo"></a>
                            </div>
                        ...
                        <div class="footer-address mt-40">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <div class="cont">
                                        <p>Head Office & Marketing Office: House # 49,
                                            Road # 12, Sector # 11 Uttara - 1230, Dhaka, Bangladesh</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="icon">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="copyright text-md-right text-center pt-15">
                            <a href="https://www.linkedin.com/in/rftriazislam/" style="color:gray"> Developed By MD
                                Riazul Islam </a>
                        </div>
                    </div>
                </div> <!-- row -->
    ...
    <!--====== Nice Number js ======-->
    <script src="{{asset('front_end/js/jquery.nice-number.min.js')}}"></script>

    <!--====== Count Down js ======-->
    <script src="{{asset('front_end/js/jquery.countdown.min.js')}}"></script>

    <!--====== Validator js ======-->
    <script src="{{asset('front_end/js/validator.min.js')}}"></script>

    <!--====== Ajax Contact js ======-->
    <script src="{{asset('front_end/js/ajax-contact.js')}}"></script>
